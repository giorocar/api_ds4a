...
np.save('data2/train_sequences_{}.npy'.format(segment), train_sequences)
np.save('data2/test_sequences_{}.npy'.format(segment), test_sequences)
y_train.to_csv('data2/y_train_{}.csv'.format(segment), index=False)
y_test.to_csv('data2/y_test_{}.csv'.format(segment), index=False)